...
public class MainFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//TODO aqui deve preencher a lista com materias dependendo do fragment
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_exit:
				Intent Login = new Intent(getActivity(), com.example.rodrigo.academicounoesc.ui.activity.LoginActivity.class);
				startActivity(Login);
				return true;
